...
float mSunLightP : CONTROLOBJECT<string name="_controller.pmx"; string item = "Directlight+";>;
float mSunLightM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Directlight-";>;
float mSunShadowRP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SunShadowR+";>;
float mSunShadowGP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SunShadowG+";>;
float mSunShadowBP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SunShadowB+";>;
float mEnvShadowP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "EnvShadow+";>;
float mSSAOP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSAO+";>;
float mSSAOM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSAO-";>;
float mSSDOP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSDO+";>;
float mSSDOM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSDO-";>;
float mSSSSP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSSS+";>;
float mSSSSM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "SSSS-";>;
float mExposureP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Exposure+";>;
float mExposureM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Exposure-";>;
float mVignette : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Vignette";>;
float mDispersion : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Dispersion";>;
float mDispersionRadius : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "DispersionRadius";>;
float mBloomThresholdP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BloomThreshold";>;
float mBloomRadius : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BloomRadius";>;
float mBloomIntensityP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BloomIntensity+";>;
float mBloomIntensityM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BloomIntensity-";>;
float mBloomStarFade : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BloomStarFade";>;
float mContrastP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Contrast+";>;
float mContrastM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Contrast-";>;
float mSaturationP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Saturation+";>;
float mSaturationM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Saturation-";>;
float mGammaP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Gamma+";>;
float mGammaM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Gamma-";>;
float mColBalanceRP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceR+";>;
float mColBalanceGP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceG+";>;
float mColBalanceBP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceB+";>;
float mColBalanceRM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceR-";>;
float mColBalanceGM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceG-";>;
float mColBalanceBM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "BalanceB-";>;
float mTemperatureP : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Temperature+";>;
float mTemperatureM : CONTROLOBJECT<string name="Karl2_controller.pmx"; string item = "Temperature-";>;
...
#include "K2_shader/textures.fxsub"
#include "K2_shader/ibl.fxsub"
#include "K2_shader/gbuffer.fxsub"
#include "K2_shader/lighting.fxsub"
#include "K2_shader/shading.fxsub"
#include "K2_shader/ColorGrading.fxsub"

#if SHADOW_QUALITY && MAIN_LIGHT_ENABLE
#	include "K2_shader/csm.fxsub"
#	include "K2_shader/shadowmap.fxsub"
#endif

#if SSDO_QUALITY && (IBL_QUALITY || MAIN_LIGHT_ENABLE)
#	include "K2_shader/PostProcessOcclusion.fxsub"
#endif

#if SSSS_QUALITY
#	include "K2_shader/PostProcessScattering.fxsub"
#endif

#if SSR_QUALITY
#	include "K2_shader/PostProcessSSR.fxsub"
#endif

#if HDR_ENABLE && HDR_EYE_ADAPTATION
#	include "K2_shader/PostProcessEyeAdaptation.fxsub"
#endif

#if HDR_ENABLE && HDR_STAR_MODE
#	include "K2_shader/PostProcessLensflare.fxsub"
#endif

#if HDR_ENABLE && HDR_FLARE_MODE
#	include "K2_shader/PostProcessGhost.fxsub"
#endif

#if HDR_ENABLE && HDR_BLOOM_MODE
#	include "K2_shader/PostProcessBloom.fxsub"
#endif

#if HDR_ENABLE
#	include "K2_shader/PostProcessHDR.fxsub"
#endif

#if AA_QUALITY == 1
#	include "K2_shader/FXAA3.fxsub"
#elif AA_QUALITY >= 2 && AA_QUALITY <= 5
#	include "K2_shader/SMAA.fxsub"
#endif
